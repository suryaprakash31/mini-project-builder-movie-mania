...
list.map((genre, index) => {
  genre.onclick = () => {
    movieURL = `https://api.themoviedb.org/3/list/${genres[index].id}?api_key=250a434176e5e3c7a8d992a9eae17e8e&language=en`
    ...
    .then(response => {
      ...
      if (response.data.items.length > 0)
        for (const item of response.data.items) {
          ...
          axios.get(`https://api.themoviedb.org/3/movie/${item.id}/videos?api_key=250a434176e5e3c7a8d992a9eae17e8e`)
          .then(response=>{
...
document.querySelector("#home").onclick=()=>{
  loadPopularOrUpcomingOrTopRatedMovies("Popular", "https://api.themoviedb.org/3/movie/popular?api_key=250a434176e5e3c7a8d992a9eae17e8e&language=en")
}
...
document.querySelector("#top-rated").onclick=()=>{
  loadPopularOrUpcomingOrTopRatedMovies("Top Rated","https://api.themoviedb.org/3/movie/top_rated?api_key=250a434176e5e3c7a8d992a9eae17e8e&language=en")
}
...
document.querySelector("#upcoming").onclick=()=>{
  loadPopularOrUpcomingOrTopRatedMovies("Upcoming","https://api.themoviedb.org/3/movie/upcoming?api_key=250a434176e5e3c7a8d992a9eae17e8e&language=en")
}

//Defaulty the popular movies get loaded into the home page
window.onload = () => {
  loadPopularOrUpcomingOrTopRatedMovies("Popular", "https://api.themoviedb.org/3/movie/popular?api_key=250a434176e5e3c7a8d992a9eae17e8e&language=en-US&page=1")
}